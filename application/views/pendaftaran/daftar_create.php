    ...
    <form class="splash-container" method="post" enctype="multipart/form-data">
        <div class="card">
            <div class="card-header">
                ...
                <p>Silakan isi data anda pada form pendaftaran ini</p>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    <input class="form-control form-control-lg" type="text" name="no_handphone" required="" placeholder="No Handphone">
                </div>
                <div class="form-group">
